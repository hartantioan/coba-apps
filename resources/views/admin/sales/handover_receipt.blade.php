                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="row">
                                            ...
                                            <div class="col m4 s6 ">
                                                <label for="filter_account" style="font-size:1rem;">Collector :</label>
                                                <div class="input-field">
                            ...
                            <div class="col s12">
                                <fieldset>
                                    ...
                                    <div class="input-field col m3 s12 step4">
                                        ...
                                        <label class="active" for="account_id">Collector</label>
                                    </div>
                                ...
                                <fieldset style="min-width: 100%;">
                                    ...
                                    <div class="col m12 s12" style="overflow:auto;width:100% !important;" id="table-item">
                                        <p class="mt-1 mb-2">
                                            ...
                                            <div>Silahkan pilih baris hingga berwarna abu-abu untuk bisa dimasukkan ke daftar Tanda Terima Kwitansi.</div>
                                            <div class="right">
                                                <a class="btn btn-small waves-effect waves-light breadcrumbs-btn right" href="javascript:void(0);" onclick="refreshMarketingReceipt();">
                                                    <i class="material-icons hide-on-med-and-up">refresh</i>
                                                    <span class="hide-on-small-onl">Refresh</span>
                                                    <i class="material-icons right">refresh</i>
                                                </a>
...
<script>
    ...
    $(function() {
            ...
            onOpenEnd: function(modal, trigger) {
                ...
                table_multi = $('#table_item').DataTable({
                    ...
                    createdRow: function(row, data, dataIndex) {
                        ...
                        $(row).attr('data-grandtotal', data.grandtotal);
                        if(data.selected){
        ...
        select2ServerSide('#account_id,#filter_account', '{{ url("admin/select2/employee") }}');
    ...
    function countTotal(){
        ...
        $('.row_item.selected').each(function(){
            total += parseFloat($(this).data('grandtotal').replaceAll(".", "").replaceAll(",","."));
        });
        $('#total').text(formatRupiahIni(total.toFixed(2).toString().replace('.',',')));
    }

    function refreshMarketingReceipt(){
        let passed = true;
    ...
    function getMarketingReceipt(){
        $('#total').text('0,00');
        table_multi.rows().remove();
        $.ajax({
            url: '{{ Request::url() }}/get_marketing_receipt',
            type: 'POST',
            dataType: 'JSON',
            data: {
            ...
            steps: [
                {
                    ...
                    intro : 'Form ini digunakan untuk mengelola beberapa data tanda terima kwitansi. Tanda terima kwitansi ini bisa berisi lebih dari satu kwitansi dengan customer yang berbeda, tergantung admin collector mengatur apakah collector ingin sekalian jalan mengantarkan kwitansi ke beberapa customer atau tidak.'
                },
                {
                    title : 'Nomor Dokumen',
                ...
                },
                {
                    ...
                    intro : 'Silahkan pilih petugas / kurir / collector yang ingin mengantarkan tanda terima kwitansi.' 
                },
                {
                    title : 'Tgl. Posting',
                    element : document.querySelector('.step5'),
                    intro : 'Tanggal posting kegiatan.' 
                },
                {
                    title : 'File Lampiran',
                ...
                {
                    title : 'Total Tagihan Kwitansi',
                    element : document.querySelector('.step7'),
                    intro : 'Total tagihan setiap kwitansi yang dipilih dari tabel Dokumen Detail. (Auto)' 
                },
                {
                    title : 'Dokumen Detail',
                    element : document.querySelector('.step8'),
                    intro : 'Data AR Invoice yang tampil disini adalah data Kwitansi.'
                },
                {
                    title : 'Keterangan',
