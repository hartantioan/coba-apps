    ...
    <body>
        <main style="padding: 0.1cm">
            ...
            <div style="font-size: 6px">
                ...
                <div style="position: fixed;left:5px;font-size:10px;width:100%;font-weight:bold;">{{ $data->code }} - {{$data->item}}</div>
                <div style="position: fixed;left:5px;font-size:8px;width:2cm">{{ (strlen($data->detail1) > 20) ? substr($data->detail1, 0, 20).'...' : $data->detail1 }}</div>
