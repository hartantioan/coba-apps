...
class ExportJournalTransactionPage implements FromView,ShouldAutoSize
{
    protected $search,$start_date, $end_date, $status, $modedata , $currency;
    public function __construct(string $search ,string $start_date, string $end_date,string $currency,string $status, string $modedata)
    {
