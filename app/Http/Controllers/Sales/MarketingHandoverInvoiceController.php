   ...
   public function getCode(Request $request){
    ...
    public function viewStructureTree(Request $request){
        ...
        if($query){
            ...
            $result = TreeHelper::treeLoop1($data_go_chart,$data_link,'data_id_hand_over_invoice',$query->id);
            $array1 = $result[0];
            $array2 = $result[1];
    ...
    public function simpleStructrueTree(Request $request){
        ...
        if($query){
            ...
            $data_go_chart[]= $data_mo_delivery;
            $result = TreeHelper::simpleTree($data_go_chart,$data_link,'data_id_hand_over_invoice',$query->id);
            $array1 = $result[0];
            $array2 = $result[1];
            $data_go_chart = $array1;
            $data_link = $array2;
