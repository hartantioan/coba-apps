    ...
    public function datatable(Request $request){
        ...
        if($query_data <> FALSE) {
            ...
            foreach($query_data as $val) {
                ...
                $btnRecreate = $val->type == '2' ? '<button type="button" class="btn-floating mb-1 btn-flat waves-effect waves-light green darken-1 white-tex btn-small" data-popup="tooltip" title="Recreate PO dan Jurnal" onclick="recall(`' . CustomHelper::encrypt($val->code) . '`)"><i class="material-icons dp48">loop</i></button> <button type="button" class="btn-floating mb-1 btn-flat waves-effect waves-light orange darken-1 white-tex btn-small" data-popup="tooltip" title="Cancel Timbang Keluar" onclick="alert(`Coming soon`);return false;revertScale(`' . CustomHelper::encrypt($val->code) . '`);"><i class="material-icons dp48">do_not_disturb</i></button>' : '';
