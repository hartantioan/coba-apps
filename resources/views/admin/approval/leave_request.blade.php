    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row mt-3 invoice-logo-title">
            <div class="col m6 s12">
                <h5 class="indigo-text">Leave Request</h5>
            </div>
        ...
        <div class="invoice-product-details mt-3">
            <div class="invoice-product-details">
                Pengajuan Ijin {{$data->leaveType->name}} oleh {{$data->account->name}}
                <br>
                Pada Tanggal {{$data->start_date}} sampai {{$data->end_date}}
                <br>
                @if ($data->leaveType->type=='2')
                <br>
                Dari jam {{$data->start_time}} sampai {{$data->end_time}}
                @endif
