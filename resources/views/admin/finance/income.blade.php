        ...
        $('#body-item').on('click', '.delete-data-item', function() {
            ...
            if($('.row_item').length == 0){
                $('#body-item').append(`
                    <tr id="empty-item">
                        <td colspan="3" class="center">
                            Harap Tambah detail terlebih dahulu
                        </td>
                    </tr>
                `);
                countAll();
                    ...
                    $.each(response.details, function(i, val) {
                        ...
                        $('#body-item').append(`
                            <tr class="row_item" data-id="">
                                ...
                                <td class="center total-column" id="total` + count + `">
                                    <input name="arr_total[]" onfocus="emptyThis(this);" id="arr_total` + count + `"  value="` + val.total + `" type="text" onkeyup="formatRupiahNoMinus(this);countAll()">
                                </td>
                            </tr>
