                    ...
                    <div class="col s12">
                        ...
                        <div class="col s12">
                            <div class="col s12 m6">
                                <h6 class="center-align">Daftar Item</h6>
                            ...
                            <div class="col s12 m6">
                                <h6 class="center-align">Daftar Customer</h6>
                                <table class="bordered" id="table-menu">
                                    <thead style="position:sticky;top: -25px !important;background-color:rgb(176, 212, 212) !important;">
                                        <tr>
                                            <th>Hapus</th>
                                    ...
                                    <tbody id="body-user">
                                        <tr id="last-row-user">
                                            <td colspan="2" style="text-align: center;">
                                                <a class="waves-effect waves-light cyan btn-small mb-1 mr-1" id="button-add-user" onclick="addUser()" href="javascript:void(0);" >
                                                    <i class="material-icons left">add</i> New user
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
    ...
    function addItem(){
        ...
        $('#last-row-item').before(`
            <tr class="row_item">
                ...
                <td class="center">
                    <select class="browser-default" id="arr_item` + count + `" name="arr_item[]" required>
    ...
    function addUser(){
        ...
        $('#last-row-user').before(`
            <tr class="row_user">
                ...
                <td class="center">
                    <select class="browser-default" id="arr_user` + count + `" name="arr_user[]" required>
                        <option value="">--Silahkan pilih Customer--</option>    
                    </select>
                </td>
            </tr>
        `);
        select2ServerSide('#arr_user' + count, '{{ url("admin/select2/customer") }}');
                    ...
                    $.each(response.items, function(i, val) {
                        ...
                        $('#last-row-item').before(`
                            <tr class="row_item">
                                ...
                                <td class="center">
                                    <select class="browser-default" id="arr_item` + count + `" name="arr_item[]" required>
                                        <option value="` + val.data.id + `">` + val.item.code  + ` - `+ val.item.name +`</option>    
                                    </select>
                                </td>
                            </tr>
                        `);
                    ...
                    $.each(response.users, function(i, val) {
                        ...
                        $('#last-row-user').before(`
                            <tr class="row_user">
                                ...
                                <td class="center">
                                    <select class="browser-default" id="arr_user` + count + `" name="arr_user[]" required>
                                        <option value="` + val.data.id + `">` + val.user.employee_no + ` - `+ val.user.name +`</option>        
                                    </select>
                                </td>
                            </tr>
                        `);
