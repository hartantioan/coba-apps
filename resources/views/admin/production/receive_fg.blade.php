                                                ...
                                                <table class="bordered" style="border: 1px solid;min-width:2500px !important;" id="table-detail-item">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td colspan="5">
                                                                TOTAL REJECT : <b id="total-reject">0,000</b>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
...
<script>
    ...
    $(function() {
        ...
        $('#modal1').modal({
            ...
            onCloseEnd: function(modal, trigger){
                ...
                $('#total-received,#total-reject').text('0,000');
                arrBatch = [];
        ...
        $('#production_barcode_detail_id').select2({
            placeholder: '-- Kosong --',
            minimumInputLength: 1,
            allowClear: true,
            cache: true,
            ...
            dropdownParent: $('body').parent(),
            ajax: {
                url: '{{ url("admin/select2/production_barcode_detail") }}',
                type: 'GET',
                dataType: 'JSON',
                data: function(params) {
                    return {
    ...
    function generateBarcode(){
        if($('#production_barcode_detail_id').val()){
            $.ajax({
            ...
            swal({
                title: 'Ups!',
                text: 'Production Order dan Data Barcode harus dipilih.',
                icon: 'warning'
            });
        }
    }
