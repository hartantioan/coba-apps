...
use App\Exports\ExportDeadStockProduction;
...
class DeadStockProductionController extends Controller
{
    ...
    public function export(Request $request){
		...
		return Excel::download(new ExportDeadStockProduction($plant,$item_id,$date), 'dead_stock_fg'.uniqid().'.xlsx');
    }
}
