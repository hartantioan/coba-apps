                        ...
                        <tbody>
                            ...
                            @foreach($data->adjustRateDetail as $key => $row)
                                <tr>
                                    ...
                                    <td align="right">{{ number_format($row->nominal_fc,2,',','.') }}</td>
                                    <td align="right">{{ number_format($row->nominal_rate,2,',','.') }}</td>
                                    <td align="right">{{ number_format($row->nominal_rp,2,',','.') }}</td>
                                    <td align="right">{{ number_format($row->nominal_new,2,',','.') }}</td>
