...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="{{ url('app-assets/images/gallery/403_error.png') }}" class="bg-image-403" width="35%" alt="">
      <!-- <h1 class="error-code m-0">403</h1> -->
      <h6 class="mb-2">UPS. Anda tidak diperbolehkan mengakses halaman ini.</h6>
