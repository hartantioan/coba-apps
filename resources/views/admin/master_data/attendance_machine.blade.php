            ...
            <div class="col s12">
                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        ...
                        <div class="input-field col s6">
                            <input id="ip_address" name="ip_address" type="text" placeholder="IP Address">
                            <label class="active" for="ip_address">IP Address</label>
                        </div>
                        <div class="input-field col s6">
                            <input id="port" name="port" type="text" placeholder="">
