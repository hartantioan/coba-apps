                                        ...
                                        <div class="col s12">
                                            <div class="card-alert card green">
                                                <div class="card-content white-text">
                                                    <p>INFO PENTING : Form ini digunakan sebagai acuan toleransi berat per item FG pada form Timbangan Truk. Jika berat timbang melebihi toleransi, maka dokumen timbang truk akan terbit approval yang harus di approve oleh pihak terkait. 1 item hanya memiliki 1 nilai prosentase timbang.</p>
                                                </div>
                                            </div>
...
<script>
    ...
    $(function() {
        ...
        select2ServerSide('#item_id', '{{ url("admin/select2/item_for_weight") }}')
    });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#item_id').empty().append(`
                    <option value="` + response.item_id + `">` + response.item_code + ` - ` + response.item_name + `</option>
                `);
                $('.modal-content').scrollTop(0);
                M.updateTextFields();
            },
