            ...
            <table border="0" width="100%" style="font-size:1em" class="tb-header">
                <tr>
                    <td width="83%" class="left-align" >
                        ...
                        <tr>
                            <td>
                                <h5 class="indigo-text">Jurnal Entry</h5>
                            </td>
                        </tr>
        ...
        <main>
            ...
            ->orderBy('type');
                                ...
                                <tr>
                                    ...
                                    <td align="right">{{ $row->type == '1' ? number_format($row->nominal_fc,2,',','.') : '' }}</td>
                                    <td align="right">{{ $row->type == '2' ? number_format($row->nominal_fc,2,',','.') : '' }}</td>
