    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row invoice-date-number">
            <div class="col xl4 s5">
                <span class="invoice-number mr-1">Komplain Sales # {{ $data->code }}</span>
            </div>
        ...
        <div class="invoice-product-details mt-3">
            <table class="bordered">
                ...
                <tbody>
                    @foreach($data->complaintSalesDetail as $key => $row)
                        <tr>
                            ...
                            <td>{{ $row->lookable->item->name }}</td>
                            <td class="right-align">{{ CustomHelper::formatConditionalQty($row->qty_color_mistake) }}</td>
                            <td class="right-align">{{ CustomHelper::formatConditionalQty($row->qty_motif_mistake) }}</td>
                            <td class="right-align">{{ CustomHelper::formatConditionalQty($row->qty_size_mistake) }}</td>
                            <td class="right-align">{{ CustomHelper::formatConditionalQty($row->qty_broken) }}</td>
                            <td class="right-align">{{ CustomHelper::formatConditionalQty($row->qty_mistake) }}</td>
                ...
                <tfoot>
                    <tr>
                        <th colspan="5" class="right-align">{{ __('translations.total') }}</th>
