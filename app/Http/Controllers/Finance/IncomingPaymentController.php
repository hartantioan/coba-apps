            ...
            if($validation->fails()) {
                ...
                elseif($total_pdf>31){
                    ...
                    for ($nomor = intval($request->range_start); $nomor <= intval($request->range_end); $nomor++) {
                        ...
                        if($query){
                            $pdf = PrintHelper::print($query,'Incoming Payment','a5','landscape','admin.print.finance.incoming_payment_individual');
    ...
    public function print(Request $request){
        ...
        if($validation->fails()) {
            ...
            foreach($request->arr_id as $key =>$row){
                ...
                if($pr){
                    $pdf = PrintHelper::print($pr,'Incoming Payment','a5','landscape','admin.print.finance.incoming_payment_individual');
                    $font = $pdf->getFontMetrics()->get_font("helvetica", "bold");
