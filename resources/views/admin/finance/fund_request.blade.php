...
<script>
    ...
    $(function() {
        ...
        $('#datatable_serverside').on('click', 'button, select, input', function(event) {
    ...
    function updateAdditionalNote(element,type){
        clearInterval(changeInterval);
        changeInterval = setInterval(function() {
            $.ajax({
                url: '{{ Request::url() }}/update_additional_note',
                type: 'POST',
                dataType: 'JSON',
                data: { 
                    id : $(element).data('id'), 
    ...
    function exportExcel(){
        ...
        window.location = "{{ Request::url() }}/export_from_page?search=" + search + "&status=" + status+ "&document=" + document + "&end_date=" + end_date + "&start_date=" + start_date + "&modedata=" + modedata;
