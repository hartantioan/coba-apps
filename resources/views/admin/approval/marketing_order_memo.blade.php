    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row invoice-date-number">
            <div class="col xl4 s5">
                <span class="invoice-number mr-1">AR Memo # {{ $data->code }}</span>
            </div>
        ...
        <div class="row mt-1 invoice-logo-title">
            <div class="col m6 s12">
                <h5 class="indigo-text">AR Memo</h5>
            </div>
        ...
        <div class="invoice-product-details mt-2" style="overflow:auto;">
            <table class="bordered">
                ...
                <tfoot>
                    <tr>
                        <th colspan="5">Terbilang : <i>{{ CustomHelper::terbilangWithKoma($data->grandtotal) }}</i></th>
                    </tr>
                </tfoot>
            </table>
        </div>
