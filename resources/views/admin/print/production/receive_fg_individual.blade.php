            ...
            <div class="card">
                <div class="card-content invoice-print-area">
                    <table border="0" width="100%" class="tbl-info">
                        <tr>
                            ...
                            <td width="30%" class="left-align" style="vertical-align: top;">
                                <table border="0" width="100%">
                                    <tr>
                                        <td>
                                            Line
                ...
                <div class="invoice-product-details">
                    <table class="bordered" border="1" width="100%" class="table-data-item" style="border-collapse:collapse">
                        <thead>
                            <tr>
                                <th align="center" colspan="11" style="font-size:16px !important;">Daftar Item Receive</th>
                            </tr>
                            <tr>
                                <th align="center">No.</th>
                                <th align="center">Item</th>
                                <th align="center">No.Batch/Palet</th>
                        ...
                        <tbody>
                            @foreach($data->productionFgReceiveDetail()->orderBy('id')->get() as $key => $row)
                                <tr>
                                    ...
                                    <td>{{ $row->pallet_no }}</td>
                                    <td>{{ $row->shading }}</td>
                                    <td align="right">{{ CustomHelper::formatConditionalQty($row->qty_sell) }}</td>
                                    <td align="center">{{ $row->itemUnit->unit->code }}</td>
                                    <td align="right">{{ CustomHelper::formatConditionalQty($row->conversion) }}</td>
                                    <td align="right">{{ CustomHelper::formatConditionalQty($row->qty) }}</td>
                                    <td align="center">{{ $row->item->uomUnit->code }}</td>
                                    <td align="">{{ $row->pallet->code }}</td>
                                    <td align="">{{ $row->grade->code }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    <table class="bordered" border="1" width="350px" class="table-data-item" style="border-collapse:collapse;margin-top:25px;">
                        <thead>
                            <tr>
                                <th colspan="5" align="center-align">Daftar Batch Terpakai</th>
                            </tr>
                            <tr>
                                <th align="center">No.</th>
                        ...
                        <tbody>
                            @foreach($data->productionBatchUsage as $key => $row)
                                <tr>
                                    ...
                                    <td align="center">{{ $row->productionBatch->item->uomUnit->code }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
