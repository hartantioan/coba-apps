...
class ReportSalesOrderRecapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            'title'     => 'Report Recap Sales Order',
            'content'   => 'admin.sales.sales_order_report_recap',
    ...
    public function export(Request $request){
		...
		return Excel::download(new ExportTransactionPageMarketingOrderDetail1('',$status,$type_sales,$type_pay,$type_deliv,$company,$customer,$delivery,$sales,$currency,$end_date,$start_date), 'sales_order_recap'.uniqid().'.xlsx');
    }
}
