                        ...
                        <div class="row">
                            <div class="col s12">
                                <fieldset>
                                    ...
                                    <div class="input-field col m3 s12">
                                        <b id="valid_date">-</b>
                                        <label class="active" for="valid_date">Tgl.Valid Hingga</label>
                                    </div>
                                    <div class="input-field col m3 s12">
                                        <b id="document_no">-</b>
                                        <label class="active" for="document_no">No.Dokumen Referensi</label>
                                    </div>
                                    <div class="input-field col m3 s12">
                                        <b id="branch_code">-</b>
                                        <label class="active" for="branch_code">Kode Cabang Mitra</label>
                                    </div>
                                </fieldset>
                            </div>
                            <div class="col s12">
                                <fieldset>
                                    ...
                                    <div class="input-field col m3 s12">
                                        <b id="type_delivery">-</b>
                                        <label class="active" for="type_delivery">Tipe Pengiriman</label>
                                    </div>
                                    <div class="input-field col m3 s12">
                                        <b id="delivery_date">-</b>
                                        <label class="active" for="delivery_date">Tgl.Pengiriman</label>
                                    </div>
                                    <div class="input-field col m3 s12">
                                        <b id="delivery_address">-</b>
                                        <label class="active" for="delivery_address">Alamat Pengiriman</label>
                                    </div>
                                    <div class="input-field col m3 s12">
                                        <b id="delivery_province">-</b>
                                        <label class="active" for="delivery_province">Provinsi Pengiriman</label>
                                    </div>
                                    <div class="input-field col m3 s12">
                                        <b id="delivery_city">-</b>
                                        <label class="active" for="delivery_city">Kota Pengiriman</label>
                                    </div>
                                    <div class="input-field col m3 s12">
                                        <b id="delivery_district">-</b>
                                        <label class="active" for="delivery_district">Kecamatan Pengiriman</label>
                                    </div>
                                </fieldset>
                            </div>
                            <div class="col s12">
    ...
    function loadDataTable() {
		window.table = $('#datatable_serverside').DataTable({
            ...
            columns: [
                ...
                { name: 'percent_dp', className: 'right-align' },
                { name: 'note', className: '' },
                ...
                { name: 'created_at', searchable: false, orderable: false, className: 'center-align' },
                { name: 'updated_at', searchable: false, orderable: false, className: 'center-align' },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(response.status == 200) {
                            ...
                            window.location = "{{ URL::to('/admin/sales/sales_order?mitra_code=') }}" + $('#temp').val();
                        } else {
                            M.toast({
                                html: response.message
                            });
    ...
    function show(id){
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#branch_code').text(response.branch_code);
                $('#type_delivery').text(response.delivery_type);
                $('#delivery_date').text(response.delivery_date);
                $('#delivery_address').text(response.delivery_address);
                $('#delivery_province').text(response.province_name);
                $('#delivery_city').text(response.city_name);
                $('#delivery_district').text(response.district_name);
                $('#payment_type').text(response.payment_type);
                $('#percent_dp').text(response.percent_dp);
                    ...
                    $.each(response.details, function(i, val) {
                        ...
                        $('#body-item').append(`
                            <tr class="row_item">
                                ...
                                <td class="center">` + val.percent_tax + `</td>
