                        ...
                        <div class="row">
                            ...
                            <div class="col s12 step6">
                                <fieldset style="min-width: 100%;">
                                    ...
                                    <div class="col m4 s6 ">
                                        <label for="filter_customer" style="font-size:1rem;">Filter Pelanggan :</label>
                                        <div class="input-field">
                                            <select class="browser-default" id="filter_customer" onchange="getMarketingInvoice()">
...
<script>
    ...
    function exportExcel(){
        ...
        window.location = "{{ Request::url() }}/export_from_page?search=" + search + "&status=" + status + "&company=" + company  + "&end_date=" + end_date + "&start_date=" + start_date;
