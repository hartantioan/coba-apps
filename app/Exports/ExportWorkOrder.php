...
class ExportWorkOrder implements FromView , WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('admin.exports.work_order', [
            'data' => WorkOrder::where(function($query) {
                if($this->search) {
                    $query->where(function($query) {
                        $query->where('code', 'like', "%$this->search%")
                            ->orWhere('detail_issue', 'like', "%$this->search%")
