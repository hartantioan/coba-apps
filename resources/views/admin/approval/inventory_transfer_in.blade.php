    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row invoice-date-number">
            <div class="col xl4 s5">
                <span class="invoice-number mr-1">{{ __('translations.inventory_transfer_in') }} # {{ $data->code }}</span>
            </div>
        ...
        <div class="row mt-3 invoice-logo-title">
            <div class="col m6 s12">
                <h5 class="indigo-text">{{ __('translations.inventory_transfer_in') }}</h5>
            </div>
            <div class="col m6 s12">
        ...
        <div class="row invoice-info">
            ...
            <div class="col m6 s6">
                ...
                <div class="row">
                    <div class="col s3">
                        {{ __('translations.reference') }}
                    </div>
                    <div class="col s9">
                        {{ __('translations.outgoing_item_number') }}. {{ $data->inventoryTransferOut->code }}
                    </div>
                    <div class="col s3">
        ...
        <table class="bordered">
            <thead>
                <tr>
                    <th class="center">{{ __('translations.from') }}</th>
        ...
        <table class="bordered" style="margin-top:25px;">
            <thead>
                <tr>
                    ...
                    <th class="center">{{ __('translations.destination_area') }}</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td colspan="5">{{ __('translations.serial') }} : {{ $row->listSerialIn() }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
