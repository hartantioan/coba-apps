            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s4 m6 l6">
                        <a class="btn btn-small waves-effect blue waves-light breadcrumbs-btn right mr-3" href="{{ url('admin/master_data/master_maintenance/equipment') }}">
                            <i class="material-icons hide-on-med-and-up">keyboard_backspace</i>
                            <span class="hide-on-small-onl">Ke Halaman Alat</span>
    ...
    function loadDataTable() {
		window.table = $('#datatable_serverside').DataTable({
            ...
            columns: [
                ...
                { name: 'spec', className: 'center-align' },
                { name: 'sparepart', className: 'center-align' },
