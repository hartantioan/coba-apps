...
class ProductionRepack extends Model
{
    use HasFactory, SoftDeletes, Notifiable;

    protected $table = 'production_repacks';
    ...
    public function productionRepackDetail()
    {
        return $this->hasMany('App\Models\ProductionRepackDetail');
    }
    ...
    public static function generateCode($prefix)
    {
        ...
        $query = ProductionRepack::selectRaw('RIGHT(code, 8) as code')
