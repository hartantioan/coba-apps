            ...
            <div class="col s12">
                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        ...
                        <div class="input-field col s6">
                            <input id="document_text" name="document_text" type="text" placeholder="Contoh : Disetujui oleh, ">
                            <label class="active" for="document_text">Keterangan di dokumen</label>
                            <a style="color:red;">*Muncul pada dokumen cetak.</a>
                        </div>
                        <div class="input-field col s6">
