...
class MailReportProcurement extends Command
{
    ...
    {
        $recipient = ['edp@superior.co.id','david@superior.co.id', 'heny@superior.co.id','livia@superior.co.id','rmpurch@superiorporcelain.co.id','michael@superiorporcelain.co.id'];
