                                    ...
                                    <div class="collapsible-body">
                                        <div class="row">
                                            ...
                                            <div class="col m4 s6 ">
                                                ...
                                                <input class="form-control" type="date" max="{{ date('Y'.'-12-31') }}" id="start_date" name="start_date"  onchange="loadDataTable()">
                                                </div>
                                            </div>
                                            <div class="col m4 s6 ">
                                                <label for="finish_date" style="font-size:1rem;">Tanggal Akhir :</label>
                                                <div class="input-field col s12">
                                                    <input class="form-control" type="date" max="{{ date('Y'.'-12-31') }}" id="finish_date" name="finish_date"  onchange="loadDataTable()">
                                                </div>
                                            </div>
                                        </div>  
                                    </div>
		...
		swal({
            ...
            if (willDelete) {
                ...
                if(passed){
                    ...
                    swal({
                        title: 'Ups!',
                        text: 'Coa selisih tidak boleh kosong.',
                        icon: 'warning'
                    });
                }
            }
    ...
    function startIntro(){
        introJs().setOptions({
            ...
            steps: [
                {
                    title : 'Purna Operasi',
                    intro : 'Form ini digunakan untuk meng-nol kan suatu aset yang masih memiliki saldo buku.'
                },
                {
                    title : 'Nomor Dokumen',
                ...
                },
                {
                    ...
                    intro : 'Perusahaan dimana dokumen dibuat'
                },
                {
                    title : 'Mata Uang',
