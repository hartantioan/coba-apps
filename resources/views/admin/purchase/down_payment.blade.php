...
<div id="modal1" class="modal modal-fixed-footer" style="min-width:90%;max-height: 100% !important;height: 100% !important;width:100%;">
    <div class="modal-content">
        <div class="row">
            <div class="col s12">
                <h6>{{ __('translations.add') }}/{{ __('translations.edit') }} {{ $title }}</h6>
    ...
    <div class="modal-footer">
        ...
        <button class="btn waves-effect waves-light mr-1 step18" onclick="save();">{{ __('translations.save') }} <i class="material-icons right">send</i></button>
                                ...
                                <div class="collapsible-body" style="display:block;">
                                    <div class="mt-2 mb-2" style="overflow:scroll;width:100% !important;">
                                        ...
                                        <table id="table_multi" class="display" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="center-align" style="@if(app()->getLocale() == 'chi') font-weight:normal !important;@endif">Kode Dokumen</th>
...
<script>
    ...
    function exportExcel(){
        ...
        window.location = "{{ Request::url() }}/export_from_page?search=" + search + "&status=" + status + "&company=" + company + "&type_pay=" + type_pay + "&supplier=" + supplier + "&currency=" + currency + "&end_date=" + end_date + "&start_date=" + start_date + "&modedata=" + modedata;
