            ...
            <table border="0" width="100%" style="font-size:1em" class="tb-header">
                <tr>
                    <td width="83%" class="left-align" >
                        <tr>
                            <td>
                                <span class="invoice-number mr-1" style="font-size:1em">Master Asset Group</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h5 style="margin-top: -2px">Asset Group Report</h5>
                            </td>
                        </tr>
                        ...
                        <tbody>
                            @foreach($data as $key => $row)
								<tr align="center">
									...
									<td>{{ $row->coa->name }}</td>
									<td>{{$row->depreciationCoa()->exists() ? $row->depreciationCoa->name : '-'}}</td>
									<td>{{$row->costCoa()->exists() ? $row->costCoa->name : '-'}}</td>
