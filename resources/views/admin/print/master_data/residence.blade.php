            ...
            <table border="0" width="100%" style="font-size:1em" class="tb-header">
                <tr>
                    <td width="83%" class="left-align" >
                        <tr>
                            <td>
                                <span class="invoice-number mr-1" style="font-size:1em">Master Residence</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h5 style="margin-top: -2px">Residence Report</h5>
                            </td>
                        </tr>
                            ...
                            @foreach($data as $key => $row)
								...
								<tr align="center">
									<td colspan="5" width="100%">
										<table border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse;width:100%; font-size:11px;">
											<thead>
												<tr align="center">
													<th colspan="{{ count($row->residenceDetail) }}">Wilayah</th>
												</tr>
											</thead>
											<tbody>
												@foreach($row->residenceDetail as $key => $rowdetail)
												@if ((($key + 1)%6 == 0))
													<tr>
												@endif
													<td align="center">{{ $rowdetail->region->name }}</td>
												@if ((($key + 1)%6 == 0))
													</tr>
												@endif
												@endforeach
