...
class ExportTransactionPageMarketingOrderReceipt implements FromCollection, WithTitle, WithHeadings, ShouldAutoSize
{
    ...
    {
        $query_data = MarketingOrderReceipt::where(function($query)  {
                if($this->search) {
    ...
    {
        return 'Marketing Order Receipt';
    }
