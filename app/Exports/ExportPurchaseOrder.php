        ...
        foreach($data as $key => $row){
            ...
            if($row->item()->exists()){
                $arr[] = [
                    ...
                    'supplier_code'     => $row->purchaseOrder->supplier->code,
                    ...
                    'due_date'          => $row->purchaseOrder->due_date ? date('d/m/Y',strtotime($row->purchaseOrder->due_date)) : '',
                    'document_date'     => $row->purchaseOrder->document_date ? date('d/m/Y',strtotime($row->purchaseOrder->document_date)) : '',
                    'tax_no'            => $row->purchaseOrder->tax_no,
                    'tax_cut_no'        => $row->purchaseOrder->tax_cut_no,
                    'cut_date'          => $row->purchaseOrder->cut_date ? date('d/m/Y',strtotime($row->purchaseOrder->cut_date)) : '',
                    'spk_no'            => $row->purchaseOrder->spk_no,
                    'invoice_no'        => $row->purchaseOrder->invoice_no,
