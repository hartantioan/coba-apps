            ...
            <div class="card">
                            ...
                            <td width="40%" class="left-align" style="vertical-align: top;">
                                <table border="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ CustomHelper::formatConditionalQty($data->qty) }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <div class="invoice-product-details">
                    <table class="bordered" border="1" width="100%" class="table-data-item" style="border-collapse:collapse">
                        <thead>
                            <tr>
                                <th align="center" colspan="6" style="font-size:16px !important;">Daftar Item (Terpakai)</th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            @foreach($data->issueGlazeDetail()->orderBy('id')->get() as $key => $row)
                                <tr>
                                    ...
                                    <td>
                                    {{ 
                                        $row->lookable_type == 'items' ? $row->lookable->code.' - '.$row->lookable->name : $row->note
                                    }}
                                    </td>
                                    <td align="right">{{ CustomHelper::formatConditionalQty($row->qty) }}</td>
                                    <td align="center">
                                        {{ 
                                            $row->lookable_type == 'items' ? $row->lookable->uomUnit->code : $row->unit->code
                                        }}
                                    </td>
