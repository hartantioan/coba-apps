...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>{{ env('APP_NAME') }} | 403 Page</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('app-assets/css/themes/vertical-modern-menu-template/materialize.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('app-assets/css/themes/vertical-modern-menu-template/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('app-assets/css/pages/page-404.css') }}">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="{{ url('app-assets/images/gallery/401_error.png') }}" class="bg-image-401" width="35%" alt="">
      <!-- <h1 class="error-code m-0">403</h1> -->
      <h6 class="mb-2">UPS. Anda tidak boleh mengakses halaman ini secara langsung.</h6>
      <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="{{ url('admin/dashboard') }}">Kembali ke Dashboard</a>
    </div>
  </div>
</div>
        </div>
