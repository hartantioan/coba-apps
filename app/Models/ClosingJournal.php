...
class ClosingJournal extends Model
{
    ...
    protected $table = 'closing_journals';
    ...
    public function closingJournalDetail()
    {
        return $this->hasMany('App\Models\ClosingJournalDetail');
    }
    ...
    public static function generateCode($prefix)
    {
        ...
        $query = ClosingJournal::selectRaw('RIGHT(code, 8) as code')
