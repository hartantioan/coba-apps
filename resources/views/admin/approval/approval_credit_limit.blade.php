    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row invoice-date-number">
            <div class="col xl4 s5">
                <span class="invoice-number mr-1">Approval Credit Limit # {{ $data->code }}</span>
            </div>
                ...
                <td width="50%" class="left-align" style="vertical-align: top !important;">
                    <table border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td width="60%">
                                {{ CustomHelper::formatConditionalQty($data->current_credit_limit) }}
                            </td>
                        </tr>
                        <tr>
                            <td width="40%">
                            ...
                            <td width="60%">
                                {{ CustomHelper::formatConditionalQty($data->new_credit_limit) }}
                            </td>
                        </tr>
                        <tr>
                            <td width="40%">
                            ...
                            <td width="60%">
                                {{ CustomHelper::formatConditionalQty($data->grandtotal) }}
                            </td>
                        </tr>
                        <tr>
                            <td width="40%">
