            ...
            <table border="0" width="100%" style="font-size:1em" class="tb-header">
                <tr>
                    <td width="83%" class="left-align" >
                        <tr>
                            <td>
                                <span class="invoice-number mr-1" style="font-size:1em">Master Machine</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h5 style="margin-top: -2px">Machine Report</h5>
                            </td>
                        </tr>
                        ...
                        <tbody>
                            @foreach($data as $key => $row)
								<tr align="center">
									<td>{{ $key+1 }}</td>
									<td>{{ $row->code }}</td>
									<td>{{ $row->line->name.' - '.$row->line->place->name }}</td>
									<td>{{ $row->name }}</td>
									<td>{{ $row->note }}</td>
								</tr>
							@endforeach
