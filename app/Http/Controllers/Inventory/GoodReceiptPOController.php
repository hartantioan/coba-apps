        ...
        if($query_data <> FALSE) {
            ...
            foreach($query_data as $val) {
                ...
                if(($val->status =='9'&& session('bo_id') == 1079 )){
                    ...
                    $btn_unlock ='
                        <button type="button" class="btn-floating mb-1 btn-flat waves-effect waves-light deep-purple white-text btn-small" data-popup="tooltip" title="Edit GRPO NEW" onclick="editGrpoNew(`' . CustomHelper::encrypt($val->code) . '`)"><i class="material-icons dp48">create</i></button>';
                }
