...
class IncomingPaymentController extends Controller
{
   ...
   public function getCode(Request $request){
            ...
            if($validation->fails()) {
                ...
                elseif($total_pdf>31){
                    ...
                    for ($nomor = intval($request->range_start); $nomor <= intval($request->range_end); $nomor++) {
                        ...
                        if($query){
                            $pdf = PrintHelper::print($query,'Incoming Payment','a4','portrait','admin.print.finance.incoming_payment_individual');
    ...
    public function print(Request $request){
        ...
        if($validation->fails()) {
            ...
            foreach($request->arr_id as $key =>$row){
                ...
                if($pr){
                    $pdf = PrintHelper::print($pr,'Incoming Payment','a4','portrait','admin.print.finance.incoming_payment_individual');
                    $font = $pdf->getFontMetrics()->get_font("helvetica", "bold");
    ...
    public function printIndividual(Request $request,$id){
        ...
        $formattedDate = $currentDateTime->format('d/m/Y H:i:s');
        if($pr){
            $pdf = PrintHelper::print($pr,'Incoming Payment','a4','portrait','admin.print.finance.incoming_payment_individual',$menuUser->mode);
    ...
    public function viewStructureTree(Request $request){
        ...
        if($query){
            ...
            $data_go_chart[]= $data_ip;
            $result = TreeHelper::treeLoop1($data_go_chart,$data_link,'data_incoming_payment',$query->id);
            $array1 = $result[0];
            $array2 = $result[1];
