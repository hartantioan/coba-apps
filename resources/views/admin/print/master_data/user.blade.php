            ...
            <table border="0" width="100%" style="font-size:1em" class="tb-header">
                <tr>
                    <td width="83%" class="left-align" >
                        <tr>
                            <td>
                                <span class="invoice-number mr-1" style="font-size:1em">Master User</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h5 style="margin-top: -2px">User Report</h5>
                            </td>
                        </tr>
                        ...
                        <tbody>
                            @foreach($data as $key => $row)
								<tr align="center">
									...
									<td>{{ $row->phone }}</td>
									<td>{{ $row->limit_credit ? number_format($row->limit_credit,0,',','.') : '-' }}</td>
								</tr>
							@endforeach
                        </tbody>
