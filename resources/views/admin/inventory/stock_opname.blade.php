                                        ...
                                        <table class="bordered" id="table-detail">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="center">Qty Adjustment</th>
                                                    <th class="center">Qty Fisik</th>
...
<script>
    ...
    function fillArrayUser(){
        arr_item = [];
        $('select[name^="arr_item[]"]').each(function(){
            if($(this).val()){
    ...
    function addItem(){
        ...
        $('#body-item').append(`
            <tr class="row_item" data-id="">
                ...
                <td>
                    <select class="browser-default item-array" id="arr_item` + count + `" name="arr_item[]" onchange="getRowUnit('` + count + `');fillArrayUser();" data-id="` + count + `"></select>
                </td>
                <td class="center" >
                ...
                <td>
                    <select class="browser-default" id="arr_type` + count + `" name="arr_type[]">
                ...
                <td>
                    <input name="arr_actual_qty[]" onfocus="emptyThis(this);" class="browser-default" type="text" value="0,000" onkeyup="formatRupiah(this);" style="text-align:right;width:100%;" id="rowQtyStore`+ count +`">
                </td>
                <td>
                    ...
                    $.each(response.details, function(i, val) {
                        ...
                        $('#body-item').append(`
                            <tr class="row_item" data-id="">
                                ...
                                <td>
                                    <input name="arr_actual_qty[]" onfocus="emptyThis(this);" class="browser-default" type="text" value="'` + val.actual_qty + `'" onkeyup="formatRupiah(this);" style="text-align:right;width:100%;" id="rowQtyStore`+ count +`">
                                </td>
                                <td>
