            ...
            <div class="col s12">
                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        ...
                        <div class="input-field col s12 m6">
                            <select class="browser-default" id="group_id" name="group_id"></select>
                            <label class="active" for="group_id">Group Customer</label>
                        </div>
                        <div class="input-field col s12 m6">
                        ...
                        <div class="col m6 s12 ">
                            <label for="start_date" style="font-size:1rem;">Start Date (Tanggal Mulai  Berlaku) :</label>
                            <div class="input-field col s12">
                                <input type="date" max="{{ date('9999'.'-12-31') }}" id="start_date" name="start_date"  onchange="loadDataTable()">
                            </div>
                        </div>
                        <div class="col m6 s12 ">
                            <label for="finish_date" style="font-size:1rem;">End Date (Tanggal Akhir Berlaku) :</label>
                            <div class="input-field col s12">
                                <input type="date" max="{{ date('9999'.'-12-31') }}" id="end_date" name="end_date"  onchange="loadDataTable()">
                            </div>
                        </div>
...
<script>
    ...
    $(function() {
        ...
        select2ServerSide('#group_id', '{{ url("admin/select2/group_customer") }}');
    });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.group_id){
                    $('#group_id').append(`
                        <option value="` + response.group['id'] + `">` + response.group['code'] + ` || ` + response.group['name'] + `</option>
                    `);
                }
