                    ...
                    $.each(response.details, function(i, val) {
                        ...
                        $('#body-item').append(`
                            <tr class="row_item" data-id="">
                                ...
                                <td class="center" >
                                    <input onfocus="emptyThis(this);" class="browser-default" type="text" value="` + val.store_stock + `" onkeyup="formatRupiah(this);" style="text-align:right;width:100%;" id="stock_store` + count + `" readonly>
                                </td>
                                <td>
                                    <input name="arr_qty_store[]" onfocus="emptyThis(this);" class="browser-default" type="text" value="` + val.store_qty + `" onkeyup="formatRupiah(this);setStockStore('` + count + `')" style="text-align:right;width:100%;" id="rowQtyStore`+ count +`">
                                </td>
                                <td class="center" id="unitStock` + count + `">
                                    ` + val.store_uom + `
                                </td>
                        ...
                        if(val.store_item_stock_id){
                            $('#arr_item_stock_store' + count).append(`
                                <option value="` + val.store_item_stock_id +`">` + val.store_item_name + `</option>
                            `);
                        }
