                                           ...
                                           <table id="datatable_serverside" >
                                               <thead>
                                                   <tr>
                                                       ...
                                                       <th align="center"  style="background-color: navy; color: white;border: 1px solid white;">{{ __('translations.code') }}</th>
...
<div id="modal1" class="modal modal-fixed-footer" style="max-height: 100% !important;height: 100% !important;">
   <div class="modal-content">
       <div class="row">
           <div class="col s12">
               <h4>{{ __('translations.add') }}/{{ __('translations.edit') }} Serah Terima Pajak</h4>
                               ...
                               <table id="table_item">
                                   <thead>
                                       <tr>
                                           ...
                                           <th align="center" colspan="4" style="background-color: navy; color: white;border: 1px solid white;">Invoice</th>
                                           <th align="center" rowspan="2" style="background-color: navy; color: white;border: 1px solid white;">Supp/Ven</th>
                                       ...
                                       <tr>
                                           ...
                                           <th align="center" style="background-color: navy; color: white;border: 1px solid white;">{{ __('translations.number') }}</th>
                                           <th align="center" style="background-color: navy; color: white;border: 1px solid white;">No.Faktur Pajak</th>
                                           <th align="center" style="background-color: navy; color: white;border: 1px solid white;">No.Bukti Potong</th>
                                       </tr>
                                   </thead>
       ...
       <div class="row">
           ...
           <div class="col s12" id="">
               ...
               <form class="row" id="form_detail" onsubmit="return false;">
                   ...
                   <div class="col s12 m12">
                       <table>
                           <thead>
                               <tr>
                                <th align="center"  style="background-color: navy; color: white;border: 1px solid white;">No</th>
                                <th align="center"  style="background-color: navy; color: white;border: 1px solid white;">Invoice</th>
                                <th align="center"  style="background-color: navy; color: white;border: 1px solid white;">Supp/Ven</th>
                                <th align="center"  style="background-color: navy; color: white;border: 1px solid white;">Tanggal Dok</th>
                                ...
                                <th align="center"  style="background-color: navy; color: white;border: 1px solid white;">Check</th>
                               </tr>
                           </thead>
                   ...
                   <div class="col s12 mt-3">
                       <button class="btn waves-effect waves-light right submit step10" onclick="saveDetail();">{{ __('translations.save') }} <i class="material-icons right">send</i></button>
                   </div>
               </form>
           </div>
       </div>
...
<script>
           ...
           onOpenEnd: function(modal, trigger) {
               ...
               table_multi = $('#table_item').DataTable({
                   ...
                   "columns": [
                        ...
                        { "data": "invoice_date" },
                        { "data": "invoice_number" },
                        { "data": "tax_invoice_number", className: "center-align" },
                        { "data": "tax_cut_number", className: "center-align" },
                        { "data": "supplier_vendor", className: "center-align" },
                        { "data": "wtax", className: "center-align" },
   ...
   function getApinHandover(){
       table_multi.rows().remove();
       $.ajax({
           url: '{{ Request::url() }}/get_apin_handover',
           type: 'POST',
           dataType: 'JSON',
           data: {
               ...
               if(response.length > 0){
                   ...
                   $.each(response, function(i, val) {
                    table_multi.row.add({
                            ...
                            'tax_invoice_number': val.tax_invoice_number,
                            'tax_cut_number': val.tax_cut_number,
