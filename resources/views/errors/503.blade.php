...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="{{ url('app-assets/images/gallery/maintenance_3.png') }}" class="bg-image-404" alt="" style="width:40% !important;">
      <h1 class="error-code m-0">503</h1>
      <h6 class="mb-2">Halaman sedang dalam pengerjaan, silahkan kembali lagi nanti.</h6>
