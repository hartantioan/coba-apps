...
class BomCalculator extends Model
{
    use HasFactory, SoftDeletes, Notifiable;

    protected $table = 'bom_calculators';
    ...
    public function bomCalculatorDetail()
    {
        return $this->hasMany('App\Models\BomCalculatorDetail');
    }
    ...
    public static function generateCode($prefix)
    {
        ...
        $query = BomCalculator::selectRaw('RIGHT(code, 8) as code')
