                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        ...
                        <div class="input-field col s12 m3">
                            <input type="text" id="service_charge" name="service_charge" onkeyup="formatRupiah(this)" value="0">
                            <label class="active" for="service_charge">Servis Charge(%)</label>
                        </div>
                        <div class="input-field col s12 m6">
    ...
    function loadDataTable() {
		window.table = $('#datatable_serverside').DataTable({
            ...
            columns: [
                ...
                { name: 'service_charge', className: 'center-align' },
