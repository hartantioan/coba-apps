        ...
        <table class="bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="center-align">{{ $row->purchase_order_detail_id ? number_format($row->purchaseOrderDetail->qty,3,',','.') : '0,000' }}</td>
                    <td class="center-align">{{ number_format($row->qty_in,3,',','.') }}</td>
