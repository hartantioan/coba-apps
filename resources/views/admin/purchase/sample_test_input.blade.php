                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                <fieldset id="modal-fieldset">
                                    ...
                                    <div class="input-field col m3 s12 step12">
                                        <input  type="text" id="wet_whiteness_value" name="wet_whiteness_value"></input>
                                        <label class="active" for="wet_whiteness_value">Nilai wet whiteness</label>
                                    </div>
                                    <div class="input-field col m3 s12 step12">
                                        <input  type="text" id="dry_whiteness_value" name="dry_whiteness_value"></input>
                                    ...
                                    <div class="input-field col m3 s12 step12">
                                        <input  id="item_name" type="text" name="item_name"></input>
                                        <label class="active" for="item_name">Nama Item</label>
                                    </div>
                                    <div class="input-field col m3 s12 step12">
                                        <input  id="test_result_note" type="text" name="test_result_note"></input>
