...
class ExportReportFundRequestOutgoing implements FromCollection, WithTitle, WithHeadings, WithCustomStartCell,ShouldAutoSize
{
    ...
    {
        return 'Laporan Fund Request to OutgoingPayment';
    }
