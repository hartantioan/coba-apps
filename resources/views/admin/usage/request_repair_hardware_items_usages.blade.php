                                           ...
                                           <form class="row" id="form_data" onsubmit="return false;">
                                                ...
                                                <div class="col s12">
                                                    ...
                                                    <div class="col s12 mt-3">
                                                        ...
                                                        <button class="btn waves-effect waves-light right submit step6" onclick="save();">{{ __('translations.save') }} <i class="material-icons right">send</i></button>
                                                    </div>
                                                </div>
                                            </form> 
                                        </div>
            ...
            <div class="col s12">
                ...
                <form class="row" id="form_data1" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        ...
                        <div class="col s12 mt-3">
                            <button class="btn waves-effect waves-light right submit" onclick="save1();">{{ __('translations.save') }} <i class="material-icons right">send</i></button>
                        </div>
                    </div>
                </form>
            </div>
