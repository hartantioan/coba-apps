    ...
    public function collection()
    {
        ...
        foreach($data as $key => $row){
            $arr[] = [
                ...
                'status'            => $row->purchaseInvoice->statusRaw(),
                ...
                'post_date'                 => date('d/m/Y',strtotime($row->purchaseInvoice->post_date)),
                'recieve_date'                 => date('d/m/Y',strtotime($row->purchaseInvoice->received_date)),
                'document_date'                 => date('d/m/Y',strtotime($row->purchaseInvoice->document_date)),
                'top'               => $row->purchaseInvoice->top() ,
                'due_date'                => date('d/m/Y',strtotime($row->purchaseInvoice->due_date)),
                'document_no'                 => $row->purchaseInvoice->document_no ,
                'invoice_no'                 => $row->purchaseInvoice->invoice_no ,
                ...
                'ref_apdp'          => $row->purchaseInvoice->listUsedApdp(),
                'date_apdp'         => $row->purchaseInvoice->listUsedApdpDate(),
                'code'              => $row->getHeaderCode(),
                'dist_biaya'        => $row->cost_distribution_id ? $row->costDistribution->code.' - '.$row->costDistribution->name : '',
