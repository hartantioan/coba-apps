...
<div id="modal1" class="modal modal-fixed-footer" style="height: 100% !important;width: 80% !important;min-height:100%;">
    ...
    function loadDataTable() {
		window.table = $('#datatable_serverside').DataTable({
            ...
            columns: [
                ...
                { name: 'time_outs', className: 'center-align' },
    ...
    function show(id){
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#time_in').val(response.start_item);
                $('#time_out').val(response.end_item);
