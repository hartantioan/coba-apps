    ...
    public function filterByDate(Request $request){
        ...
        if($results || $results2){
            foreach($results as $row){
                $total_received_after_adjust = round(($row->balance * $row->currency_rate) + $row->adjust_nominal + $row->adjust_nominal2,2);
                ...
                $data_tempura = [
                    ...
                    'rec_date'  => $row->received_date ? date('d/m/Y',strtotime($row->received_date)) : '-',
            ...
            foreach($results2 as $row){
                $total_received_after_adjust = round(($row->grandtotal * $row->currency_rate) + $row->adjust_nominal + $row->adjust_nominal2,2);
