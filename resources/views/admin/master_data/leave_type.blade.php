...
<div id="modal1" class="modal modal-fixed-footer" style="max-height: 100% !important;height: 80% !important;">
    <div class="modal-content">
        <div class="row">
            <div class="col s12">
                <h4>{{ __('translations.add') }}/{{ __('translations.edit') }} Shift</h4>
                    ...
                    <div class="col s12">
                        ...
                        <div class="input-field col s4">
                            <select class="form-control" id="type" name="type"> 
                                <option value="1">{{ __('translations.date') }}</option>
                        ...
                        <div class="input-field col s4">
                            <select class="form-control" id="furlough_type" name="furlough_type"> 
                                ...
                                <option value="6">Dispen</option>
                                <option value="7">Melahirkan</option>
                                <option value="8">Ijin</option>
                                <option value="9">Telat</option>
                            </select>
                            <label class="" for="furlough_type">{{ __('translations.type') }}</label>
                        </div>
