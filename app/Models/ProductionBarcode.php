...
class ProductionBarcode extends Model
{
    ...
    protected $table = 'production_barcodes';
    ...
    {
        return $this->hasMany('App\Models\ProductionBarcodeDetail');
    }
    ...
    public function alreadyReceived(){
        $yeah = true;
        foreach($this->productionBarcodeDetail as $row){
            if(!$row->productionFgReceiveDetail()->exists()){
                $yeah = false;
            }
        }
        return $yeah;
