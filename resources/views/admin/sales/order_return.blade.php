                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                <fieldset style="min-width: 100%;">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m5 step8">
                                    ...
                                    <div class="col m12 s12 step10" style="overflow:auto;width:100% !important;" id="table-item">
                                        <p class="mt-2 mb-2">
    ...
    $(function() {
        ...
        $('#body-item').on('click', '.delete-data-item', function() {
            ...
            if($('.row_item').length == 0){
                ...
                $('#form_data')[0].reset();
                $('#marketing_order_delivery_process_id,#account_id').empty();
                $('#table-item').animate( { 
                    scrollLeft: '0' }, 
                500);
            }
                    ...
                    if(response.status == 500){
                        ...
                        $('#list-used-data').append(`
                            <div class="chip purple darken-4 gradient-shadow white-text">
                                ` + $('#marketing_order_delivery_process_id').select2('data')[0].code + `
                                <i class="material-icons close data-used" onclick="removeUsedData('` + $('#marketing_order_delivery_process_id').val() + `')">close</i>
                            </div>
                        `);
                        ...
                        $.each($('#marketing_order_delivery_process_id').select2('data')[0].details, function(i, val) {
                            ...
                            $('#body-item').append(`
                                <tr class="row_item" data-id="` + $('#marketing_order_delivery_process_id').val() + `">
                                    ...
                                    <td>
                                        <input name="arr_qty[]" class="browser-default" type="text" value="0" onkeyup="formatRupiahNoMinus(this);countRow('` + count + `')" data-qty="` + val.qty_sent + `" style="text-align:right;width:100%;" id="rowQty`+ count +`">
                                    </td>
                                    <td class="center">
                                        ` + val.unit + `
                                    </td>
                            ...
                            `);
                            $.each(val.item_warehouse, function(l, value) {
                    ...
                    $.each(response.details, function(i, val) {
                        ...
                        $('#body-item').append(`
                            <tr class="row_item" data-id="` + val.marketing_order_delivery_process_id + `">
                                ...
                                <td>
                                    <input name="arr_qty[]" class="browser-default" type="text" value="` + val.qty + `" onkeyup="formatRupiahNoMinus(this);countRow('` + count + `')" data-qty="` + val.qty_sent + `" style="text-align:right;width:100%;" id="rowQty`+ count +`">
                                </td>
                                <td class="center">
                                    ` + val.unit + `
                                </td>
            ...
            steps: [
                {
                    ...
                    intro : 'Form ini digunakan untuk mengelola data barang return dari Surat Jalan yang belum menjadi AR Invoice.'
                },
                {
                    title : 'Nomor Dokumen',
                ...
                },
                {
                    ...
                    intro : 'Partner bisnis tipe Pelanggan. Silahkan pilih sesuai dengan customer yang ingin mengembalikan barang. Hati-hati ketika memilih partner bisnis maka, daftar surat jalan akan terfilter sesuai BP ini.' 
                },
                {
                    title : 'Perusahaan',
                ...
                },
                {
                    ...
                    intro : 'Data yang tampil disini adalah data tarikan dari Surat Jalan. Jumlah qty barang yang tampil adalah barang yang terkirim dikurangi dengan barang yang sudah diretur.'
                },
                {
                    title : 'Keterangan',
