                            ...
                            <ul class="collapsible collapsible-accordion">
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="row">
                                            <div class="col m4 s6 ">
                                                <label for="filter_type">Tipe Order</label>
                                                <select class="browser-default item-array" id="filter_type" name="filter_type" onchange="loadDataTable()">
                                            ...
                                            <div class="input-field col m3 s12">
                                                ...
                                                <select class="browser-default " id="item_id" name="item_id" onchange="loadDataTable()">
