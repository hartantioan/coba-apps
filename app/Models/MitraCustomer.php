...
class MitraCustomer extends Model{
    ...
    protected $fillable   = [
        ...
        'top',
        'top_internal',
        'status_approval',  // Status Approval: 1 Approved, 2 Pending Insert, 3 Pending Update, 4 Rejected
    ...
    public function statusApproval(){
        $status_approval = match ($this->status_approval) {
          ...
          '4' => '<span class="red medium-small white-text padding-3">Rejected</span>',
