                                        ...
                                        <div class="col s12">
                                            <div class="card-alert card purple">
                                                <div class="card-content white-text">
                                                    <p>Info : Pastikan periode yang ingin ditutup sudah memiliki Closing Jurnal.</p>
                                                </div>
                                            </div>
                                            <div class="card-alert card red">
                                                <div class="card-content white-text">
                                                    <p>Info Status : Status <b>Buka</b> artinya, dokumen bisa diakses oleh siapapun yang memiliki akses pada periode terpilih. Status <b>Tutup</b> artinya, dokumen hanya bisa diakses oleh Pengguna Spesial yang diberikan akses saja pada periode yang dipilih. Status <b>Kunci</b> artinya, dokumen dikunci dan tidak bisa melakukan transaksi tambah ataupun void pada periode terpilih baik pengguna biasa ataupun pengguna spesial.</p>
                                                </div>
                                            </div>
                    ...
                    <div class="col s12">
                        <div class="row">
                            ...
                            <div class="input-field col s3 step5">
                                <input id="month" name="month" type="month" placeholder="Periode depresiasi" value="{{ date('Y-m') }}">
                                <label class="active" for="month">Periode Tutup (Bulan)</label>
                            </div>
                        ...
                        <div class="row">
                            <div class="col s6 step7">
                                <h5>Pengguna Spesial</h5>
                                <p>Pengguna Spesial hanya bisa akses dokumen yang memiliki status <b>Tutup</b></p>
                                <table class="bordered">
                                    <thead>
                                        <tr>
                                            <th class="center" width="15%">No.</th>
                                            <th class="center" width="55%">Nama</th>
                                            <th class="center" width="30%">Hapus</th>
                                        </tr>
                                    </thead>
                                    <tbody id="body-detail">
                                        <tr id="last-row-detail">
                                            <td colspan="3" class="center">
                                                <a class="waves-effect waves-light cyan btn-small mb-1 mr-1 mt-1 step31" onclick="addUser()" href="javascript:void(0);">
    ...
    function startIntro(){
        introJs().setOptions({
            ...
            steps: [
                {
                    title : 'Kunci Periode',
                    intro : 'Form ini digunakan untuk men-kunci seluruh transaksi pada suatu periode (bulan) terpilih, baik itu transaksi tambah baru, edit, maupun void dokumen.'
                },
                {
                    title : 'Nomor Dokumen',
                ...
                {
                    title : 'List Data Pengguna Spesial',
                    element : document.querySelector('.step7'),
                    intro : 'Silahkan tentukan pengguna spesial, untuk bisa akses semua form transaksi ketika status closing adalah TUTUP.' 
                },
                {
                    title : 'Tombol Simpan',
