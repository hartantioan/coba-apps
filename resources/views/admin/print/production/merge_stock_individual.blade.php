            ...
            <div class="card">
                            ...
                            <td width="40%" class="left-align" style="vertical-align: top;">
                                <table border="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $data->itemStock->itemShading->code }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            {{ CustomHelper::formatConditionalQty($data->qty).' '.$data->item->uomUnit->code }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <div class="invoice-product-details">
                    <table class="bordered" border="1" width="100%" class="table-data-item" style="border-collapse:collapse">
                        <thead>
                            <tr>
                                <th align="center" colspan="9" style="font-size:16px !important;">Daftar Item (Terpakai)</th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            @foreach($data->mergeStockDetail()->orderBy('id')->get() as $key => $row)
                                <tr>
                                    ...
                                    <td>{{ $row->itemStock->area->name }}</td>
                                    <td>{{ $row->itemStock->productionBatch->code }}</td>
                                    <td>{{ $row->itemStock->itemShading->name }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
