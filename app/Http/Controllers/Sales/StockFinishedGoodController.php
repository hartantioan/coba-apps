...
use App\Exports\ExportSalesFinishedGood;
...
class StockFinishedGoodController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'group'     =>  $itemGroup,
            'content'   => 'admin.sales.sales_finished_good_report',
    ...
    public function filter(Request $request){
        ...
        ->where(function($query) use ( $request) {
            $query->whereHas('item',function($query) use($request){
                ...
                ->whereHas('parentFg',function($query) use($request){
    ...
    public function export(Request $request){
		...
		return Excel::download(new ExportSalesFinishedGood($plant,$item,$warehouse,$finish_date), 'production_batch_stock'.uniqid().'.xlsx');
    }
}
