...
class AdjustRate extends Model
{
    use HasFactory, SoftDeletes, Notifiable;

    protected $table = 'adjust_rates';
    ...
    {
        return $this->hasMany('App\Models\AdjustRateDetail');
    }
    ...
    public static function generateCode($prefix)
    {
        ...
        $query = AdjustRate::selectRaw('RIGHT(code, 8) as code')
