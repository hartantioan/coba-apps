                        ...
                        <div class="row">
                            <div class="col s12">
                                <fieldset id="modal-fieldset">
                                    ...
                                    <div class="input-field col m3 s12 step12">
                                        <input  type="text" id="lab_name" name="lab_name" placeholder=" " ></input>
                                        <label class="active" for="lab_name">Nama Laboratorium</label>
                                    </div>
                                    <div class="input-field col m3 s12 step12">
...
<script>
    ...
    $(function() {
        ...
        select2ServerSide('#sample_test_input_id', '{{ url("admin/select2/sample_test_input_proc") }}');
