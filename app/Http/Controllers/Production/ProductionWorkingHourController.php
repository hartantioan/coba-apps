...
use App\Models\ProductionWorkingHourDetail;
...
class ProductionWorkingHourController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'content'       => 'admin.production.production_working_hour',
    ...
    public function getCode(Request $request){
        ...
        $code = ProductionWorkingHour::generateCode($request->val);
    ...
    public function datatable(Request $request){
        ...
        $total_data = ProductionWorkingHour::count();
        
        $query_data = ProductionWorkingHour::where(function($query) use ($search, $request) {
                if($search) {
                    $query->where(function($query) use ($search, $request) {
                        $query->where('code', 'like', "%$search%")
                            ...
                            })->orWhereHas('shift',function($query) use ($search, $request){
                                $query->where('name','like',"%$search%")
                                ->orWhere('code','like',"%$search%");
                            });
                    });
        ...
        $total_filtered = ProductionWorkingHour::where(function($query) use ($search, $request) {
                if($search) {
                    $query->where(function($query) use ($search, $request) {
                        $query->where('code', 'like', "%$search%")
                            ->orWhere('note','like',"%$search%")
