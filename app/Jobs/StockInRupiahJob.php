...
class StockInRupiahJob implements ShouldQueue
{
    ...
    {
        $filename = 'stock_in_rupiah_' . uniqid() . '.xlsx';

        Excel::store(new ExportStockInRupiah($this->plant,$this->item,$this->warehouse,$this->start_date,$this->finish_date,$this->type,$this->group), 'public/report/'.$filename);
        Notification::create([
            'code'				=> Str::random(20),
            'menu_id'			=> 0,
            ...
            'lookable_id'		=> 0,
            'title'				=> 'Report telah berhasil diproses Stock In Rupiah Mohon Ditunggu',
