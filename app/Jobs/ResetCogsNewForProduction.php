...
class ResetCogsNewForProduction implements ShouldQueue
{
        ...
        foreach($marketingorderdelivery as $row){
            ...
            if($row->marketingOrderMemoDetail()->exists()){
                foreach($row->marketingOrderMemoDetail as $rowmemo){
                    self::dispatch($rowmemo->marketingOrderMemo->post_date,$rowmemo->marketingOrderMemo->company_id,$rowmemo->itemStock->place_id,$rowmemo->itemStock->item_id,$rowmemo->itemStock->area_id,$rowmemo->itemStock->item_shading_id,$rowmemo->itemStock->production_batch_id);
                }
            }
        }
      }
