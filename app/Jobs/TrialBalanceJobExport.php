...
class TrialBalanceJobExport implements ShouldQueue
{
    ...
    {
        $filename = 'trial_balance_' . uniqid() . '.xlsx';

        Excel::store(new ExportTrialBalance($this->month_start,$this->month_end,$this->level,$this->company), 'public/report/'.$filename);
        Notification::create([
            'code'				=> Str::random(20),
            'menu_id'			=> 0,
            ...
            'lookable_id'		=> 0,
            'title'				=> 'Report telah berhasil diproses Trial Balance Mohon Ditunggu',
