            ...
            <table border="0" width="100%" style="font-size:1em" class="tb-header">
                <tr>
                    <td width="83%" class="left-align" >
                        ...
                        <tr>
                            <td>
                                <h3 class="indigo-text">Tanda Terima Dokumen Dipersamakan FP</h3>
                            </td>
                        </tr>
        ...
        <main>
            <div class="card" style="margin-top: 2%">
                <table border="0" width="100%" class="tbl-info">
                    <tr>
                        <td width="44%" class="left-align" style="vertical-align: top !important;">
                        ...
                        <td width="22%" class="left-align" style="vertical-align: top !important;">
                    ...
                    <table class="bordered table-with-breaks table-data-item " border="1" style="border-collapse:collapse;" width="100%"  >
                        <thead>
                            <tr>
                                ...
                                <th class="center" >Supp/Ven</th>
                                <th class="center" >Tanggal Dok</th>
                                <th class="center" >DPP</th>
                        ...
                        <tbody>
                            @php
                                $sortedDetails = $data->HandoverPurchaseInvoiceDetail->sortBy(function($detail) {
                            ...
                            @endphp
                                <tr>
                                    ...
                                    <td>{{ $row->purchaseInvoice->account->name ?? '' }}</td>
                                    <td>{{ date('d/m/Y', strtotime($row->post_date)) }}</td>
                                    <td align="right">{{ number_format($row->purchaseInvoice->wtax, 2, ',', '.') }}</td>
                                    <td align="right">{{ number_format($row->purchaseInvoice->tax, 2, ',', '.') }}</td>
                                    <td  class="center" style="color:{{$row->statusColor()}}">{{ $row->status() }}</td>
                                </tr>
                            @endforeach
                        </tbody>
