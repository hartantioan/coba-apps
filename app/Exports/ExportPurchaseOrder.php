            ...
            if($row->item()->exists()){
                ...
                if(!$row->deleted_at ||($row->deleted_at&&$row->purchaseOrder->deleted_at)){
                    ...
                    $arr[] = [
                        ...
                        'nik_creator'       => $row->purchaseOrder->user->employee_no,
                        'name_creator'      => $row->purchaseOrder->user->name,
                        ...
                        'payment_type'      => $row->purchaseOrder->paymentType(),
                        ...
                        'item_group'        => $row->item->itemGroup->name,
                        ...
                        'conversion'        => $this->nominal ? $row->purchaseOrder->currency_rate : '',
                        'disc1'             => $this->nominal ? $row->percent_discount_1 : '',
                        'disc2'             => $this->nominal ? $row->percent_discount_2 : '',
