                ...
                <div class="section section-data-tables">
                    ...
                    <div class="row">
                        ...
                        <div class="col l12 m12 s12 p-3 center-align">
                            <div class="card-alert card red"><div class="card-content white-text"><p>MOHON DIPERHATIKAN!! PASTIKAN BARANG SAMPAI DI CUSTOMER BARU TEKAN TANDA CENTANG (✔️) DI ATAS.</p></div></div>
                        </div>
                    </div>
                </div>
            </div>
