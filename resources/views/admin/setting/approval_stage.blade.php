                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        ...
                        <div class="col m12 s12">
                            <p class="mt-2 mb-2">
                                <h4>Detail Karyawan Approver</h4>
    ...
    function loadDataTable() {
		window.table = $('#datatable_serverside').DataTable({
            ...
            columns: [
                ...
                { name: 'min_approve', searchable: false, orderable: false, className: 'center-align' },
                { name: 'min_reject', searchable: false, orderable: false, className: 'center-align' },
