            ...
            <table border="0" width="100%">
                <tr>
                    <td width="83%" class="left-align">
                        <tr>
                            <td>
                                <span class="invoice-number mr-1" style="font-size:10px;margin-bottom:0px">AR Credit Memo # {{ $data->code }}</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <table border="1" style="border-collapse:collapse" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right">{{ number_format($row->total_after_tax,2,',','.') }}</td>
