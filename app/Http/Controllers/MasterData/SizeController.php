...
class SizeController extends Controller
{
    public function index()
    {
        $data = [
            'title'     => 'Ukuran',
            'content'   => 'admin.master_data.size',
        ];
    ...
    public function create(Request $request){
        $validation = Validator::make($request->all(), [
            'code' 				=> $request->temp ? ['required', Rule::unique('sizes', 'code')->ignore($request->temp)] : 'required|unique:sizes,code',
            'name'              => 'required',
        ], [
