    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="invoice-product-details mt-2" style="overflow:auto;width:100%;">
            <table class="bordered" style="min-width:1400px !important;">
                <thead>
                    <tr>
                        <th align="center" colspan="5" style="font-size:16px !important;">Daftar Item (Terpakai)</th>
                    </tr>
                    <tr>
                        <th align="center">{{ __('translations.no') }}.</th>
                        <th align="center">Issue GP No.</th>
                ...
                <tbody>
                    @foreach($data->receiveGlazeDetail()->orderBy('id')->get() as $key => $row)
                        <tr>
                            ...
                            <td>
                            {{ 
                                $row->issueGlaze->item->code.' - '.$row->issueGlaze->item->name
                            }}
                            </td>
                            <td align="right">{{ CustomHelper::formatConditionalQty($row->qty) }}</td>
                            <td align="center">
                                {{ 
                                    $row->issueGlaze->item->uomUnit->code
                                }}
                            </td>
                        </tr>
                    @endforeach
