        ...
        if($validation->fails()) {
            ...
            if($query){
                ...
                if($query->approvalSource->lookable_type == 'good_issue_requests'){
                    ...
                    if(session('bo_employee_no') == '120171'){
                        foreach($query->approvalSource->lookable->goodIssueRequestDetail as $row){
                            $row->update([
                                'status'    => '1'
                            ]);
                        }
                ...
                $response = [
                    'status'  => 500,
                    'message' => 'Data approval tidak ditemukan, bisa jadi karena telah anda approve. Silahkan refresh halaman.',
                ];
            }
		}
