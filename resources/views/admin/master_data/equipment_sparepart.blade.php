                ...
                <div class="row">
                    <div class="col s8 m6 l6">
                        ...
                        <ol class="breadcrumbs mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="#">{{ Str::title(str_replace('_',' ',Request::segment(5))) }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ Str::title(str_replace('_',' ',Request::segment(7))) }}
                            </li>
                        </ol>
                    </div>
                    <div class="col s4 m6 l6">
                        <a class="btn btn-small waves-effect blue waves-light breadcrumbs-btn right mr-3" href="{{ url('admin/master_data/master_maintenance/equipment/part').'/'.$equipmentpart->equipment_id }}">
                            <i class="material-icons hide-on-med-and-up">keyboard_backspace</i>
                            <span class="hide-on-small-onl">Ke Halaman Part</span>
    ...
    function loadDataTable() {
		window.table = $('#datatable_serverside').DataTable({
            ...
            columns: [
                ...
                { name: 'spesification', className: 'center-align' },
                { name: 'description', className: 'center-align' },
                { name: 'file', className: 'center-align' },
