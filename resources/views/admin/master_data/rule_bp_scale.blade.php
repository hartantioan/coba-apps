                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        <div class="input-field col s12 m6">
                            ...
                            <label class="active" for="account_id">Vendor</label>
                        </div>
                        <div class="input-field col s12 m6">
                            <select class="browser-default" id="rule_procurement_id" name="rule_procurement_id"></select>
                            <label class="active" for="rule_procurement_id">Rule</label>
                        </div>
                        <div class="input-field col s12 m6">
            ...
            <div class="col s12">
                ...
                <form class="row" action="{{ Request::url() }}/import" method="POST" enctype="multipart/form-data" id="form_dataimport">
                    ...
                    <div class="input-field col m6 s12">
                        <h6>Anda bisa menggunakan fitur upload dokumen excel. Silahkan klik <a href="{{ asset(Storage::url('format_imports/format_fg_group.xlsx')) }}" target="_blank">disini</a> untuk mengunduh. Item yang sudah terdaftar pada Grup Item FG tidak bisa didaftarkan melalui import atau di-lewati. Silahkan hapus item yang sudah terdaftar.</h6>
                    </div>
