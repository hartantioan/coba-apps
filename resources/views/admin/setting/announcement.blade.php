                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        <div class="input-field col s12 m12">
                            ...
                            <input id="description" name="description" type="text" placeholder="Isi Pengumuman">
                        ...
                        <div class="col m6 s12 ">
                            <label for="end_date" style="font-size:1rem;">End Date (Tanggal Akhir Posting) :</label>
                            <div class="input-field col s12">
                                <input type="date" max="{{ date('9999'.'-12-31') }}" id="end_date" name="end_date"  onchange="loadDataTable()">
                            </div>
                        </div>
                        <div class="input-field col s12 m12">
                            <select class="select2 browser-default" multiple="multiple" id="menu_id" name="menu_id[]">
                            </select>
                            <label class="active" for="menu_id">Menu</label>
                        </div>
                        <div class="input-field col s12">
...
<script>
    $(function() {
        ...
        select2ServerSide('#menu_id', '{{ url("admin/select2/menu") }}');
    });
