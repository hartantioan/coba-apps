...
class ExportMarketingOrderPlanTransactionPage implements FromCollection, WithTitle, WithHeadings, ShouldAutoSize
{
            ...
            if($this->search) {
                $query->where(function($query) {
                    $query->where('code', 'like', "%$this->search%")
                        ...
                        ->orWhereHas('marketingOrderPlanDetail',function($query){
