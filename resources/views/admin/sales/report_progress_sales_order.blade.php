                                            ...
                                            <div class="col s12">
                                                <div class="row">
                                                    ...
                                                    <div class="col m4 s6 ">
                                                        ...
                                                        <div class="input-field">
                                                            <select class="select2 browser-default" multiple="multiple" id="filter_currency" name="filter_currency" >
                                                    ...
                                                    <div class="col m4 s6 ">
                                                        ...
                                                        <input type="date" max="{{ date('9999'.'-12-31') }}" id="start_date" name="start_date"   >
                                                        </div>
                                                    </div>
                                                    <div class="col m4 s6 ">
...
<script>
    ...
    function exportExcel(){
        ...
        window.location = "{{ Request::url() }}/export?search=" + search + "&status=" + status + "&type_buy=" + type_buy + "&type_deliv=" + type_deliv + "&company=" + company + "&type_pay=" + type_pay + "&supplier=" + supplier + "&currency=" + currency + "&finish_date=" + finish_date + "&start_date=" + start_date;
