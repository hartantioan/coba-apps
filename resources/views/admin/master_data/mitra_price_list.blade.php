    ...
    function loadDataTable() {
		window.table = $('#datatable_serverside').DataTable({
            ...
            columns: [
                ...
                { name: 'price_group_code', className: '',  },
                { name: 'sales_area_code', className: '' },
                { name: 'variety', className: '' },
                { name: 'type', className: '' },
                { name: 'package', className: '' },
                { name: 'effective_date', className: '' },
                { name: 'uom', className: '' },
                { name: 'min_qty', className: '' },
                { name: 'price_exclude', className: '' },
                { name: 'price_include', className: '' },
