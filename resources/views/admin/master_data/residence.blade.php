                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        ...
                        <div class="col s12 mt-3">
                            <h5 class="center">Daftar Wilayah</h5>
                            <p class="mt-2 mb-2">
                                <table class="bordered">
                                    ...
                                    <tbody id="body-region">
                                        <tr id="last-row-region">
                                            <td colspan="2" class="center">
                                                <a class="waves-effect waves-light cyan btn-small mb-1 mr-1" onclick="addRegion()" href="javascript:void(0);">
                                                    <i class="material-icons left">add</i> Tambah Wilayah
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
...
<script>
    ...
    function addRegion(){
        var count = $('select[name^="arr_region"]').length;
        $('#last-row-region').before(`
            <tr class="row_region">
                <td>
                    <select class="browser-default region-array" id="arr_region` + count + `" name="arr_region[]"></select>
                </td>
                <td class="center">
                    <a class="mb-6 btn-floating waves-effect waves-light red darken-1 delete-data-region" href="javascript:void(0);">
                        <i class="material-icons">delete</i>
                    </a>
                </td>
            </tr>
        `);
        select2ServerSide('#arr_region' + count, '{{ url("admin/select2/region") }}');
    }
