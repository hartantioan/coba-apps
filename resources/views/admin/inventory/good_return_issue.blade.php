                    ...
                    <div class="col s12">
                                    ...
                                    <p class="mt-2 mb-2">
                                        ...
                                        <div>
                                            <table class="bordered" style="min-width:1500px;" id="table-detail">
                                                <thead>
                                                    <tr>
                                                        <th class="center" rowspan="2">{{ __('translations.item') }}</th>
                                                        ...
                                                        <th class="center" rowspan="2">{{ __('translations.unit') }}</th>
                                                        <th class="center" rowspan="2">{{ __('translations.note') }}</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 mt-3">
                                <button class="btn waves-effect waves-light right submit step9" onclick="save();">{{ __('translations.save') }} <i class="material-icons right">send</i></button>
                            </div>
                        </div>
                    </div>
                </form>
