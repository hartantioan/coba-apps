    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row invoice-date-number">
            <div class="col xl4 s5">
                <span class="invoice-number mr-1">Barang Transfer Masuk # {{ $data->code }}</span>
            </div>
        ...
        <div class="row mt-3 invoice-logo-title">
            <div class="col m6 s12">
                <h5 class="indigo-text">Barang Transfer Masuk</h5>
            </div>
            <div class="col m6 s12">
        ...
        <div class="row invoice-info">
            ...
            <div class="col m6 s6">
                ...
                <div class="row">
                    ...
                    <div class="col s9">
                        Barang Keluar No. {{ $data->inventoryTransferOut->code }}
                    </div>
                    <div class="col s3">
                        Lampiran
                    </div>
