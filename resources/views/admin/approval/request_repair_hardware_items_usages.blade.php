    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row mt-3 invoice-logo-title">
            <div class="col m6 s12">
                <h5 class="indigo-text">Request Repair Hardware Item</h5>
            </div>
        ...
        <div class="invoice-product-details">
            Pengajuan perbaikan untuk Hardware Item {{$data->hardwareItem->item->name}} dengan kode {{$data->hardwareItem->code}}
            <br>
            <b>Keluhan: </b> {{$data->complaint}}
        </div>
