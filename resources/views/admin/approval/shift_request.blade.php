    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row mt-3 invoice-logo-title">
            <div class="col m6 s12">
                <h5 class="indigo-text">Shift Request</h5>
            </div>
                ...
                <td width="33%" class="left-align" style="vertical-align: top !important;">
                    <table border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td width="60%">
                                {{ $data->account->position->Level->name }}
                            </td>
                        </tr>
                        <tr>
                            <td width="40%">
        ...
        <div class="invoice-product-details mt-3">
            <div class="invoice-product-details">
                Pengajuan Ijin Tukar Shift oleh {{$data->account->name}}
                <br>
                <table class="bordered">
                    <thead>
                        <tr>
                            <th class="center">No</th>
                            <th class="center">Shift awal</th>
                            <th class="center">Tanggal yang ingin diubah</th>
                            <th class="center">Shift Baru</th>
                            <th class="center">Tanggal yang menjadi tujuan</th>
          
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($data->shiftRequestDetail as $key => $row)
                            <tr>
                                <td class="center-align">{{ $key + 1 }}</td>
                                <td>{{ $row->employeeSchedule->shift->name }}</td>
                                <td class="center-align">{{ $row->employeeSchedule->date }}</td>
                                <td class="center-align">{{ $row->shift->name }}</td>
