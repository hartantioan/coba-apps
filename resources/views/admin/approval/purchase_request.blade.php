    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row invoice-date-number">
            <div class="col xl4 s5">
                <span class="invoice-number mr-1">Request # {{ $data->code }}</span>
            </div>
            ...
            <table class="mt-3" width="100%" border="0">
                <tr>
                    <td class="center-align">
                        ...
                        <div class="mt-1">{{ $data->user->position->name }}</div>
                        <div>{{ $data->user->department->name }}</div>
                    </td>
                    @if($data->approval())
                    @foreach ($data->approval()->approvalMatrix()->where('status','2')->get() as $row)
                        <td class="center-align">
                            ...
                            <div class="mt-1">{{ $row->user->position->name }}</div>
                            <div>{{ $row->user->department->name }}</div>
                        </td>
                    @endforeach
                @endif
                </tr>
