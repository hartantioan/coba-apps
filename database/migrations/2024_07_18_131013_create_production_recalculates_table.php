...
return new class extends Migration
{
    ...
    {
        Schema::create('production_recalculates', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['user_id','company_id','void_id','delete_id','done_id'],'prc_index');
        });
    }
    ...
    {
        Schema::dropIfExists('production_recalculates');
    }
};
