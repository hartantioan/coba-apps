...
class SendMailPOJob implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;
    protected $po_id, $item, $warehouse, $start_date, $finish_date,$type,$group;

    protected $user_id;
    public function __construct(string $po_id ,string $user_id)
    {
