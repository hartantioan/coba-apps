            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s4 m6 l6">
                        ...
                        <a class="btn btn-small waves-effect waves-light breadcrumbs-btn right mr-3 modal-trigger" href="#modal_muat_fg">
                            <i class="material-icons hide-on-med-and-up">rv_hookup</i>
                            <span class="hide-on-small-onl">Scan Muat</span>
                            <i class="material-icons right">rv_hookup</i>
                        </a>
                        <a class="btn btn-small waves-effect waves-light breadcrumbs-btn right mr-3 modal-trigger" href="#modal_done_fg">
                            <i class="material-icons hide-on-med-and-up">done_all</i>
                            <span class="hide-on-small-onl">Scan Done Muat</span>
                                            ...
                                            <div class="col m4 s6 ">
                                                ...
                                                <div class="input-field">
                                                    <select class="form-control" id="filter_status" onchange="loadDataTable()" multiple>
                                                        ...
                                                        <option value="3">MUAT FG</option>
                                                        <option value="4">SELESAI MUAT FG</option>
            ...
            <div class="col s12">
                ...
                <form class="row" id="form_data" onsubmit="return false;">
                    ...
                    <div class="col s12">
                        ...
                        <div class="input-field col s4 step2">
...
<div id="modal_muat_fg" class="modal modal-fixed-footer" style="min-width:90%;max-height: 100% !important;height: 100% !important;width:100%;">
    <div class="modal-content">
        <div class="row">
            <div class="col s12">
                <h4>{{ __('translations.add') }}/{{ __('translations.edit') }} {{ $title }}</h4>
                <form class="row" id="form_data_muat" onsubmit="return false;">
                    <div class="col s12">
                        <div id="validation_alert" style="display:none;"></div>
                    </div>
                    <div class="col s12">
                        ...
                        <div class="input-field col s12 m3 step5">
                            <textarea class="materialize-textarea" id="code_barcode_muat" name="code_barcode_muat" placeholder="Kode Barcode" rows="3"></textarea>
                            <label class="active" for="code_barcode">Kode Barcode</label>
                        </div>
                        <div class="col s12"></div>
                        <div class="col s12 mt-3">
                            <button class="btn waves-effect waves-light right submit step10" onclick="updateMuatScan();">{{ __('translations.save') }} <i class="material-icons right">send</i></button>
                        </div>
                    </div>
                </form>
            </div>
...
<div id="modal_done_fg" class="modal modal-fixed-footer" style="min-width:90%;max-height: 100% !important;height: 100% !important;width:100%;">
    <div class="modal-content">
        <div class="row">
            <div class="col s12">
                <h4>{{ __('translations.add') }}/{{ __('translations.edit') }} {{ $title }}</h4>
                <form class="row" id="form_data_done" onsubmit="return false;">
                    <div class="col s12">
                        <div id="validation_alert" style="display:none;"></div>
                    </div>
                    <div class="col s12">
                        <div class="card">
                            ...
                            <div class="card-content row" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                ...
                                <div style="text-align: center;">
                                    <video id="video2" width="100%" height="auto" style="border: 1px solid gray;"></video>
                                </div>

                                <div id="sourceSelectPanel2" style="display:none">
                                    <label for="sourceSelect2">Change video source:</label>
                                    <select id="sourceSelect2" style="max-width:400px" class="browser-default">
                                    </select>
                                </div>

                                <div style="margin-top: 10px; text-align: center;">
                                    <a class="btn btn-small waves-effect waves-light breadcrumbs-btn" id="startButton2">Start</a>
                                    <a class="btn btn-small waves-effect waves-light breadcrumbs-btn" id="resetButton2">Reset</a>
                                </div>
                        ...
                        <div class="input-field col s12 m3 step5">
                            <textarea class="materialize-textarea" id="code_barcode_done" name="code_barcode_done" placeholder="Kode Barcode" rows="3"></textarea>
                            <label class="active" for="code_barcode">Kode Barcode</label>
                        </div>
                        <div class="col s12"></div>
                        <div class="col s12 mt-3">
                            <button class="btn waves-effect waves-light right submit step10" onclick="updateDoneScan();">{{ __('translations.save') }} <i class="material-icons right">send</i></button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    window.addEventListener('load', function () {
        ...
        .then((videoInputDevices) => {
            ...
            codeReader.decodeFromVideoDevice(selectedDeviceId, 'video', (result, err) => {
                if (result) {
                    document.getElementById('code_barcode_muat').value = result.text;
                }
    ...
    function StartMuat(id){
		$.ajax({
            url: '{{ Request::url() }}/update_muat_status',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateMuatScan(id){
		var formData = new FormData($('#form_data_muat')[0]);
        $.ajax({
            url: '{{ Request::url() }}/update_muat_scan',
            type: 'POST',
            dataType: 'JSON',
            data: formData,
            contentType: false,
    ...
    function updateDoneScan(id){
		var formData = new FormData($('#form_data_done')[0]);
        $.ajax({
            url: '{{ Request::url() }}/update_done_muat_scan',
            type: 'POST',
            dataType: 'JSON',
            data: formData,
            contentType: false,
    ...
    function doneMuat(id){
		$.ajax({
            url: '{{ Request::url() }}/update_done_muat',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
