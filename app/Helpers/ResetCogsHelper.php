...
{
    public static function gas(string $date = null, int $company_id = null, int $place_id = null, int $item_id = null, int $area_id = null, int $item_shading_id = null, int $production_batch_id = null)
    {
            ...
            foreach($productionissue as $row){
                ...
                foreach($row->productionBatchUsage as $rowbatch){
                    if($bomGroup == '1'){
                        ...
                        $rowprice = round($rowbatch->productionBatch->total / $rowbatch->productionBatch->qty_real,5);
