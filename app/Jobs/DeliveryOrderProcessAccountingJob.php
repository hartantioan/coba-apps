...
class DeliveryOrderProcessAccountingJob implements ShouldQueue
{
    ...
    {
        $filename = 'surat_jalan_recap_accounting_' . uniqid() . '.xlsx';

        Excel::store(new ExportDeliveryOrderProcessAccountingRecap($this->start_date, $this->end_date), 'public/report/'.$filename);
        Notification::create([
            'code'				=> Str::random(20),
            'menu_id'			=> 0,
