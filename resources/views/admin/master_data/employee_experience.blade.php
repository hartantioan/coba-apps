...
<script>
    ...
    function loadDataTable() {
		...
		window.table = $('#datatable_serverside').DataTable({
            ...
            "order": [[0, 'desc']],
            ajax: {
                url: '{{ URL::to('/') }}/admin/master_data/master_hr/employee/datatable_work_experience',
                type: 'GET',
                data: {
            ...
            columns: [
                ...
                { name: 'company_name', className: 'center-align' },
                { name: 'position', className: 'center-align' },
                { name: 'month_start', className: 'center-align' },
                { name: 'month_end', className: 'center-align' },
                { name: 'job_description', className: 'center-align' },
    ...
    function save(){
        ...
        $.ajax({
            url: '{{ URL::to('/') }}/admin/master_data/master_hr/employee/create_work_experience',
            type: 'POST',
            dataType: 'JSON',
            data: formData,
            contentType: false,
    ...
    function show(id){
        $.ajax({
            url: '{{ URL::to('/') }}/admin/master_data/master_hr/employee/show_experience',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function destroy(id){
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: '{{ URL::to('/') }}/admin/master_data/master_hr/employee/destroy_experience',
                    type: 'POST',
                    dataType: 'JSON',
                    data: { id : id },
                    headers: {
