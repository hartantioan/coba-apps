    ...
    <div class="card-content invoice-print-area">
        ...
        <div class="row invoice-date-number">
            <div class="col xl4 s5">
                <span class="invoice-number mr-1">{{ __('translations.good_return_issue') }} # {{ $data->code }}</span>
            </div>
        ...
        <div class="row mt-3 invoice-logo-title">
            <div class="col m6 s12">
                <h5 class="indigo-text">{{ __('translations.good_return_issue') }}</h5>
            </div>
            <div class="col m6 s12">
        ...
        <table class="bordered">
            <thead>
                <tr>
                    ...
                    <th align="center" colspan="4">{{ __('translations.from') }}</th>
                    <th align="center" rowspan="2">{{ __('translations.qty_out') }}</th>
                    <th align="center" rowspan="2">{{ __('translations.qty_return') }}</th>
