...
class ExportTransactionPageMarketingOrderReturn implements FromCollection, WithTitle, WithHeadings, ShouldAutoSize
{
    ...
    {
        $query_data = MarketingOrderReturn::where(function($query)  {
                if($this->search) {
                    $query->where(function($query)  {
                        $query->where('code', 'like', "%$this->search%")
                            ...
                            ->orWhereHas('marketingOrderReturnDetail',function($query) {
