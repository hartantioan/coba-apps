                ...
                if($row_item_request_detail->purchaseRequestDetail()->exists()){
                    ...
                    foreach($row_item_request_detail->purchaseRequestDetail as $row_pr_detail){
                        ...
                        $pr=[
                            ...
                            'pr_approve_date' => $row_pr_detail->purchaseRequest->approve_date ? date('Y-m-d', strtotime($row_pr_detail->purchaseRequest->approve_date)) : '-',
                        ...
                        if($row_pr_detail->purchaseOrderDetail()->exists()){
                            ...
                            foreach($row_pr_detail->purchaseOrderDetail as $row_po_detail){
                                $po=[
                                    ...
                                    'po_approve_date' => $row_pr_detail->purchaseRequest->approve_date ? date('Y-m-d', strtotime($row_po_detail->purchaseOrder->approve_date)) : '-',
