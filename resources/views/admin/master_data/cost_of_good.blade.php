...
<div id="modal_price_list" class="modal modal-fixed-footer" style="max-height: 100% !important;height: 80% !important;">
        ...
        <div class="row">
            <div class="col s12">
                ...
                <form class="row" id="form_price_list" onsubmit="return false;">
                    ...
                    <div class="input-field col s12 m3">
                        <input type="text" id="price" name="price" onkeyup="formatRupiah(this)" value="0">
                        <label class="active" for="price">Harga Satuan</label>
                    </div>

                    <div class="input-field col s12 m3">
                        <input type="text" id="discount" name="discount" onkeyup="formatRupiah(this)" value="0">
                    ...
                    <div class="col s12 mt-3">
                        <button class="btn waves-effect waves-light right submit" onclick="save();">
                            {{ __('translations.save') }} <i class="material-icons right">send</i>
                        </button>
                    </div>
    ...
    <div class="modal-footer">
        <a href="javascript:void(0);" class="modal-action modal-close waves-effect waves-red btn-flat">
