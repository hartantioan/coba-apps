              ...
              <table class="email-body_inner" align="center" width="650" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-cell">
                    <h1>No PO :{{$data['result']->code}}  Supplier : {{$data['supplier']}}</h1>
                    <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <div>
                                ...
                                <br>
                                <br>
                                <p class="sub">Setiap PO dari PT Superior Porcelain Sukses harus dikonfirmasi kembali apabila telah disetujuhi oleh Supplier dengan mengirimkan countersigned PO (PO yang bertandatangan & Berstempel supplier) ke email ini.
                                </p>
                                <br>
                                <br>
                                <br>
                    ...
                    <table class="body-sub">
                      <tr>
                        <td>
                          <p class="sub">Jika anda mengalami masalah dalam data yang dikirimkan anda dapat menghubungi no dibawah ini.
                          </p>
                          <p class="sub">
