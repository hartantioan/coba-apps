...
class MarketingOrderHandoverInvoice extends Model
{
    use HasFactory, SoftDeletes, Notifiable;

    protected $table = 'marketing_order_handover_invoices';
    ...
    {
        return $this->hasMany('App\Models\MarketingOrderHandoverInvoiceDetail');
    }
    ...
    public static function generateCode($prefix)
    {
        ...
        $query = MarketingOrderHandoverInvoice::selectRaw('RIGHT(code, 8) as code')
